                ...
                <div class="p-6 text-gray-900">
                    <div class="overflow-hidden overflow-x-auto bg-white">
                        <div class="min-w-full align-middle">
                            ...
                            <a href="{{ route('users.create') }}" class="underline">{{ __('Create new user') }}</a>
                            <br /><br />
                            @endcan
                            ...
                            <table class="min-w-full border divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <th class="bg-gray-50 px-6 py-3 text-left">
                                        <span class="text-xs font-medium uppercase leading-4 tracking-wider text-gray-500">{{ __('Role') }}</span>
                                    </th>
                                </tr>
                                </thead>
