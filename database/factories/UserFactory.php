...
class UserFactory extends Factory
{
    ...
    private string $clinicDefaultName = 'Default Clinic';
    ...
    public function masterAdmin(): static
    {
        return $this->afterCreating(function (User $user) {
            ...
            $team = Team::create([
                'name' => __('Master Administrator Team'),
            ]);
    ...
    public function clinicOwner(): static
    {
        return $this->afterCreating(function (User $user) {
            $team = Team::create([
                'name' => __($this->clinicDefaultName),
            ]);
    ...
    {
        return $this->afterCreating(function (User $user) {
            $team = Team::firstOrCreate(['name' => __($this->clinicDefaultName)]);
